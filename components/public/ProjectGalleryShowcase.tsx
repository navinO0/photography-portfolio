          ...
          return (
            ...
            >
              ...
              <div className="absolute top-1.5 right-1.5 sm:top-4 sm:right-4 z-20 pointer-events-none">
                <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-none border border-amber-400/60 bg-black/90 backdrop-blur-md flex items-center justify-center text-white opacity-80 group-hover:opacity-100 group-hover:bg-amber-500 group-hover:text-white group-hover:border-amber-400 transition-colors shadow-lg">
              ...
              <div className="absolute top-1.5 left-1.5 sm:top-4 sm:left-4 z-20 pointer-events-none">
                <span className="px-1.5 py-0.5 sm:px-3 sm:py-1 bg-black/90 backdrop-blur-md text-[7px] sm:text-[9px] uppercase font-mono text-white border border-amber-500/30">
                  FRAME 0{idx + 1}
                </span>
              </div>
            </div>
